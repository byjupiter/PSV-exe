...
class everything():
    ...
    #setup search
    everything_dll.Everything_SetSearchW("2213ANS-02M-01-001A_0-용접.dxf")
    ...
    def get_time(filetime,WINDOWS_TICKS_TO_POSIX_EPOCH,WINDOWS_TICKS):
    ...
    for i in range(num_results):
        ...
        print("Filename: {}\nDate Modified: {}\nSize: {} bytes\n".format(ctypes.wstring_at(filename),get_time(date_modified_filetime,WINDOWS_TICKS_TO_POSIX_EPOCH,WINDOWS_TICKS),file_size.value))